...
export type IUserActions = ILogInRequest | ILogInSuccess | ILogInFailure | ISignUpRequest | ISignUpSuccess | ISignUpFailure | ILogOutRequest | ILogOutSuccess | ILogOutFailure | ILoadProfileRequest | ILoadProfileSuccess | ILoadProfileFailure | IUpdateRequest | IUpdateSuccess | IUpdateFailure;
